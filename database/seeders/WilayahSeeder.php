...
class WilayahSeeder extends Seeder
{
    ...
    {
        $file_prov = public_path('wilayahs/provinsi.json');
        $file_kab = public_path('wilayahs/kabupaten.json');
        $file_kec = public_path('wilayahs/kecamatan.json');
        $file_kel = public_path('wilayahs/kelurahan.json');
        ...
        foreach ($chunk_kel as $key => $chunk) {
            ...
            DB::table('desa_kelurahans')->insert($chunk);
            echo "Done seeder";
        }
    }
}
